---
layout: post
title: "Elastisch 1.1.0-beta1 is released"
date: 2013-02-26 20:52
comments: false
categories: 
  - elastisch
  - releases
...
[1.1.0-beta1](https://clojars.org/clojurewerkz/elastisch/versions/1.1.0-beta1) is a development release that has several new features, most notably a native client with the
...
We recommend all users to give [1.1.0-beta1](https://clojars.org/clojurewerkz/elastisch/versions/1.1.0-beta1)
a try.
