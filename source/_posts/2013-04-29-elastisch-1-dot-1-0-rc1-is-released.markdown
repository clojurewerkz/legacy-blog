---
layout: post
title: "Elastisch 1.1.0-rc1 is released"
...
[1.1.0-rc1](https://clojars.org/clojurewerkz/elastisch/versions/1.1.0-rc1) is
...
We recommend all users to give [1.1.0-rc1](https://clojars.org/clojurewerkz/elastisch/versions/1.1.0-rc1)
a try.
...
Elastisch 1.1 will be released once we update [Elastisch documentation](http://clojureelasticsearch.info) to cover all the
new features.
