...
[2.2.0](https://clojars.org/clojurewerkz/elastisch/versions/2.2.0) is a feature release
of Elastisch.

Elastisch `2.2.0` is the last release to target ElasticSearch `1.7`. After
that Elastisch development will focus on ElasticSearch `2.x` (and Elastisch `3.0`).
