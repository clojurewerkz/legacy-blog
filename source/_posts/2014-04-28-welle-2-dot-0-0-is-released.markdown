---
layout: post
title: "Welle 2.0.0 is released"
date: 2014-04-28 23:51:36 +0400
comments: false
categories:
  - welle
  - releases
...
[2.0.0](https://clojars.org/com.novemberain/welle/versions/2.0.0) is a
major release that *has breaking API changes* and introduces an
important bug fix, dependency updates and support for Riak 1.4
features.

It does not include our [recently announced "explicit client" changes](http://blog.clojurewerkz.org/blog/2014/04/26/major-breaking-public-api-changes-coming-in-our-projects/). Those will
be part of 3.0.
